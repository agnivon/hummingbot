...
class AsterOrderBookTests(TestCase):

    def test_snapshot_message_from_exchange(self):
        snapshot_message = AsterOrderBook.snapshot_message_from_exchange(
    ...
    def test_diff_message_from_exchange(self):
        diff_msg = AsterOrderBook.diff_message_from_exchange(
            msg={
                "e": "depthUpdate",
                "E": 123456789,
                "s": "COINALPHAHBOT",
    ...
    def test_trade_message_from_exchange(self):
        ...
        trade_message = AsterOrderBook.trade_message_from_exchange(
