...
class AsterExchangeTests(AbstractExchangeConnectorTests.ExchangeConnectorTests):
    ...
    def trading_rules_url(self):
        url = web_utils.private_rest_url(
            CONSTANTS.EXCHANGE_INFO_PATH_URL,
        )
        return url
    ...
    def create_exchange_instance(self):
        return AsterExchange(
            aster_api_key="testAPIKey",
            aster_api_secret="0x0123456789abcdef0123456789abcdef0123456789abcdef0123456789abcdef",  # noqa: mock
    ...
    def _validate_auth_credentials_taking_parameters_from_argument(self, request_call_tuple, params):
        self.assertIn("nonce", params)
        self.assertIn("user", params)
        self.assertIn("signer", params)
        self.assertIn("signature", params)
        self.assertEqual(self.exchange.api_key, params["user"])
    ...
    def validate_order_creation_request(self, order: InFlightOrder, request_call: RequestCall):
        ...
        self.assertEqual(AsterExchange.aster_order_type(OrderType.LIMIT), request_data["type"])
    ...
    def test_update_order_fills_request_parameters(self, mock_api):
        ...
        self.exchange._last_trades_poll_aster_timestamp = 10
        self.async_run_with_timeout(self.exchange._update_order_fills_from_trades())
