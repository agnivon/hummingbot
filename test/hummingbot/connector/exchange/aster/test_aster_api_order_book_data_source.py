...
class AsterAPIOrderBookDataSourceUnitTests(IsolatedAsyncioWrapperTestCase):
    ...
    async def asyncSetUp(self) -> None:
        ...
        self.data_source = AsterAPIOrderBookDataSource(
    ...
    @aioresponses()
    @patch("hummingbot.connector.exchange.aster.aster_api_order_book_data_source" ".AsterAPIOrderBookDataSource._sleep")
