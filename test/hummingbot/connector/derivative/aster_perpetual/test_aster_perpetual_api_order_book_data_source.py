...
class AsterPerpetualAPIOrderBookDataSourceUnitTests(IsolatedAsyncioWrapperTestCase):
    ...
    async def asyncSetUp(self) -> None:
        ...
        self.connector = AsterPerpetualDerivative(
            aster_perpetual_api_key="",
            aster_perpetual_api_secret="",
