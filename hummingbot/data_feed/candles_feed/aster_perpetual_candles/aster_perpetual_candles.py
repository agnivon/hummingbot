...
from hummingbot.data_feed.candles_feed.aster_perpetual_candles import constants as CONSTANTS
from hummingbot.data_feed.candles_feed.candles_base import CandlesBase
from hummingbot.logger import HummingbotLogger


class AsterPerpetualCandles(CandlesBase):
    ...
    @property
    def name(self):
        return f"aster_perpetual_{self._trading_pair}"
