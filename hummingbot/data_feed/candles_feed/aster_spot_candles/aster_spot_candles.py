...
from hummingbot.data_feed.candles_feed.aster_spot_candles import constants as CONSTANTS
from hummingbot.data_feed.candles_feed.candles_base import CandlesBase
from hummingbot.logger import HummingbotLogger


class AsterSpotCandles(CandlesBase):
    ...
    @property
    def name(self):
        return f"aster_{self._trading_pair.lower()}"
