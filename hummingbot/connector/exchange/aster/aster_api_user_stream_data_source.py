...
class AsterAPIUserStreamDataSource(UserStreamTrackerDataSource):
        ...
        while True:
            try:
                data = await rest_assistant.execute_request(
                    ...
                    throttler_limit_id=CONSTANTS.ASTER_USER_STREAM_PATH_URL,
    ...
    async def _ping_listen_key(self) -> bool:
        ...
        try:
            data = await rest_assistant.execute_request(
                url=web_utils.public_rest_url(path_url=CONSTANTS.ASTER_USER_STREAM_PATH_URL),
    ...
    async def _connected_websocket_assistant(self) -> WSAssistant:
        ...
        url = f"{CONSTANTS.USER_STREAM_WSS_URL[self._domain]}?listenKey={self._current_listen_key}"
    ...
    async def _subscribe_channels(self, websocket_assistant: WSAssistant):
        ...
        Aster does not require any channel subscription.
